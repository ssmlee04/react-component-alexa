  ...
  render() {
    ...
    return (
      <div style={{ width: '100%', padding: 5, fontSize: 8 }}>
        ...
        <div style={{ fontSize: 8, color: 'gray' }}>Generated by <span style={{ color: 'darkred' }}>@earningsfly</span> with <span style={{ fontSize: 16, color: 'red' }}>❤️</span>, datasource: alexa.com</div>
      </div>
    );
  }
}
